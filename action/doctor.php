...
<html lang="en">
<head>
    <link rel="stylesheet" href="../asssets/css/doctor.css">
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        ?>
        <ul class="ulist">
            <li ><a href="../action/doctor.php" id="active">Home</a></li>
            <!-- <li><a href="#news">News</a></li> -->
            <li class=dropdown>
                <a href="javascript:void(0)" class="dropbtn">Patients</a>
                <div class="dropdown-content">
                    <a href="../action/medical_history.php">Medical history</a>
                    <!-- <a href="#">Link 3</a> -->
                </div>
            </li>
        ...
        <div id="body">
            <div class="left">
                <div class="staff-top">
                    <h2 class="schedule">Patient details</h2>
                    <div class=scroll>
                        <table id="patient">
                    ...
                    <a href="../action/medical_history.php"><b>View medical history</b></a>
                    <div class="staff-top">
                        <h2 class="schedule">Prescriptions</h2>
                        <div class=scroll>
                            <table id="theatre">
                                <tr style="color:#bd1616">
                                    <td>Id</td>
