...
<html lang="en">
<head>
    <link rel="stylesheet" href="../asssets/css/admission.css">
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <ul class="ulist">
            ...
            <li class=dropdown>
                ...
                <div class="dropdown-content">
                    <a href="../action/admission.php" id="active">Admission</a>
        ...
        <div class="left-form">
            <form name="patient" method="POST" action="../src/insert_admission.php">
                <table class="update" style="width: 100%;">
                    <!-- <tr>
                        <td class="label">Admission Id:</td>
                        <td colspan="3">
                            <input type="text" name="id" class="inputs" placeholder="insert admission id" required> 
                        </td>
                        </tr>
                    <tr> -->
                ...
                <div class=scroll>
                    ...
                    <table class="data-table">
                        ...
                        <?php
                            ...
                            {
                                echo "<tr><td>".$row['adid']."</td><td>".$row['adtime']."</td><td>".$row['addate']."</td><td>".$row['adfee']."</td><td>".$row['sid']."</td><td>".$row['pemail']."</td></tr>";
                            }
                        ?>
                    </table>
                </div>
